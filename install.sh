...
AUTOUPDATER_VERSION="1.0.32"  # Semantic version with proper SSH host configuration
...
install_autoupdater() {
    ...
    local INSTALL_UPDATER_CHECKSUM="e9d0075873834a034dbcef5cc34638efc2b620bada047f3145550bf1fb7f3825"
    local AUTOUPDATER_SH_CHECKSUM="849f52642b648118e04f990e0a05eb9762f9139b2dc2a32ed4946616b75a1d60"
