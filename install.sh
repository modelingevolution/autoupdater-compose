...
AUTOUPDATER_VERSION="1.0.34"  # Replaced from autoupdater.version file
...
install_autoupdater() {
    ...
    local INSTALL_UPDATER_CHECKSUM="6f9d43cff020234832ca8e540d537b7a3dc2643698de2da98b6db778e290af04"
