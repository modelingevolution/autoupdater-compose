...
echo "AutoUpdater Install Script v1.0.60 ($(date '+%Y-%m-%d %H:%M:%S'))"

# Configuration variables
AUTOUPDATER_VERSION="1.0.60"  # Replaced from autoupdater.version file
...
install_autoupdater() {
    ...
    local INSTALL_UPDATER_CHECKSUM="b45a8a25858bf76c37261d66148aff7e64b4c0c2bd9aa13768548903058e00b5"
