...
AUTOUPDATER_VERSION="1.0.40"  # Replaced from autoupdater.version file
...
install_autoupdater() {
    ...
    local INSTALL_UPDATER_CHECKSUM="c9eb694dc76f573bca291bb61fbdb144a1e8b3b20ef993fd173da61985f204b8"
