...
AUTOUPDATER_VERSION="1.0.33"  # Replaced from autoupdater.version file
...
install_autoupdater() {
    ...
    local INSTALL_UPDATER_CHECKSUM="5c7cf18ca329d8c007df254d92abaf7f33a6de9424556484db59dfb6d49e11a6"
